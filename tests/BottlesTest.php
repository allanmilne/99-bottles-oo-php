...
class BottlesTest extends TestCase
{
    ...
    public function test_a_couple_verses(): void
    {
        ...
        self::assertEquals($expected, (new Bottles())->verses(99, 98));
    }
    ...
    public function test_a_few_verses(): void
    {
        ...
        self::assertEquals($expected, (new Bottles())->verses(2, 0));
    }

    public function test_the_whole_song(): void
    {
        $expected = <<< SONG
...
SONG;
        self::assertEquals($expected, (new Bottles())->song());
    }
}
